...
if expand('%:p') ==# expand('<sfile>:p')
  unlet! g:loaded_vim_depoxy_webopen_config
endif

if exists('g:loaded_vim_depoxy_webopen_config') || &cp

  finish
endif

let g:loaded_vim_depoxy_webopen_config = 1
...
" FIXME/2025-02-23: Add key descriptions for which-key.
